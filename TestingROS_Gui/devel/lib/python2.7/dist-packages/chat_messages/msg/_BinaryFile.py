...
"""autogenerated by genpy from chat_messages/BinaryFile.msg. Do not edit."""
import sys
...
class BinaryFile(genpy.Message):
  _md5sum = "4f4f2455f5d960a16307ee71094083ee"
  _type = "chat_messages/BinaryFile"
...
string frame_id
"""
  __slots__ = ['header','sender','text','data_name','data']
  _slot_types = ['std_msgs/Header','string','string','string','byte[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,sender,text,data_name,data
    ...
    """
    if args or kwds:
      super(BinaryFile, self).__init__(*args, **kwds)
