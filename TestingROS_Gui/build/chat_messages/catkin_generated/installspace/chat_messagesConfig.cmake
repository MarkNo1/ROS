...
if("FALSE" STREQUAL "TRUE")
  set(chat_messages_SOURCE_PREFIX /home/mark/Project/TestingROS_Gui/src/chat_messages)
  set(chat_messages_DEVEL_PREFIX /home/mark/Project/TestingROS_Gui/devel)
  ...
  set(chat_messages_INSTALL_PREFIX /home/mark/Project/TestingROS_Gui/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'chat_messages' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mark/Project/TestingROS_Gui/install/${idir}'.  ${_report}")
    endif()
